...
import XenonpyVis from '../VisComponents/XenonpyVis';
import XenonpyForm from './XenonpyForm';
...
//-------------------------------------------------------------------------------------------------
export default class XenonpyView extends withCommandInterface(
  XenonpyVis,
  XenonpyForm
) {
  handleSubmit = (values) => {
    if (values.featureColumns.length == 0) {
      throw 'No data to work with';
    }
